        ...
        <Fade>
          ...
          <div className="container__networks">
            <a
              ...
              className="container__networks__item"
              target="_blank"
            >
              <img
            ...
            <a
              href="https://wa.link/5ayf76"
              className="container__networks__item"
              target="_blank"
            >
              <img
                src="https://img.icons8.com/office/25/000000/whatsapp--v1.png"
                alt={"..."}
              />
            </a>
            <a
            ...
            >
              <img
                src="https://img.icons8.com/fluency/25/000000/linkedin.png"
                alt={"..."}
              />
            </a>
          </div>
